...
export default function Home() {
    ...
    const handleBundleDetailsChange = (service: keyof BundleDetails, value: string): void => {
        setBundleDetails({
            ...bundleDetails,
            [service]: value === '' ? null : parseInt(value)
        });
    };
    ...
    const calculateTotal = (): string => {
        ...
        if (selectedServices.dataBundles && dataBundles !== null && dataBundles > 0) {
    ...
    const hasFilledRequiredFields = (): boolean => {
        for (const service in selectedServices) {
            if (selectedServices[service as keyof ServiceSelection] &&
                service !== 'validity' &&
                (bundleDetails[service as keyof Omit<BundleDetails, 'validity'>] ?? 0) <= 0) {
                return false;
            }
        }
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    id="dataBundles"
                                                    min="1"
                                                    value={bundleDetails.dataBundles === null ? '' : bundleDetails.dataBundles}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    id="callMinutes"
                                                    min="1"
                                                    value={bundleDetails.callMinutes === null ? '' : bundleDetails.callMinutes}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    id="sms"
                                                    min="1"
                                                    value={bundleDetails.sms === null ? '' : bundleDetails.sms}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    id="airtime"
                                                    min="1"
                                                    value={bundleDetails.airtime === null ? '' : bundleDetails.airtime}
                        ...
                        {step === 3 && (
                            <div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4 mb-6">
                                    ...
                                    {selectedServices.dataBundles && bundleDetails.dataBundles !== null && bundleDetails.dataBundles > 0 && (
                                    ...
                                    {selectedServices.callMinutes && bundleDetails.callMinutes !== null && bundleDetails.callMinutes > 0 && (
                                        <div className="flex justify-between py-2 border-b border-gray-200">
                                    ...
                                    {selectedServices.sms && bundleDetails.sms !== null && bundleDetails.sms > 0 && (
                                        <div className="flex justify-between py-2 border-b border-gray-200">
                                    ...
                                    {selectedServices.airtime && bundleDetails.airtime !== null && bundleDetails.airtime > 0 && (
                                        <div className="flex justify-between py-2 border-b border-gray-200">
